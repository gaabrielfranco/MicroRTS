 ...
 * @author gabriel
 */
public class POLightRushV2 extends LightRush {
	
	GameState gameState;
	Unit unit;
	UnitAction possibleAction;

    public POLightRushV2(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    public POLightRushV2(UnitTypeTable a_utt, GameState gs, Unit u, UnitAction a) {
    	this(a_utt, new AStarPathFinding());
    ...
    public AI clone() {
        return new POLightRushV2(utt, pf);
    }
