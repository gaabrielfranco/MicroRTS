 ...
 * @author santi
 */
public class POHeavyRushV2 extends HeavyRush {
	
	GameState gameState;
	Unit unit;
	UnitAction possibleAction;

    public POHeavyRushV2(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    public POHeavyRushV2(UnitTypeTable a_utt, GameState gs, Unit u, UnitAction a) {
    	this(a_utt, new AStarPathFinding());
