 ...
 * @author rubens
 */
public class PGSLimit extends AIWithComputationBudget implements InterruptibleAI{
    ...
    public PGSLimit(UnitTypeTable utt) {
        this(100, -1, 200, 2, 2, 
    ...
    public PGSLimit(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    */
    ...
    @Override
    public AI clone() {
        return new PGSLimit(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
