 ...
 * @author rubens
 */
public class GranularityPGSLimitRB extends AIWithComputationBudget implements InterruptibleAI {
	...
	public GranularityPGSLimitRB(UnitTypeTable utt) {
	...
	public GranularityPGSLimitRB(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e,
	...
	@Override
	public AI clone() {
		return new GranularityPGSLimitRB(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
	}
